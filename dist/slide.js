(function($) {
    ...
    function Slide($this, option) {
        ...
        if ($.type(this.opt.pagination) === 'string') {
            this._$pagination = this.$this.children(this.opt.pagination) || $(this.opt.pagination);
        ...
        this._$widget = this._$btNprev.add(this._$btNnext).add(this.$pagination);
        ...
        this._needDuplicateEdge = this.opt.autoPlay || this.opt.next;
    ...
    Slide.prototype = {
                ...
                for (var i = 0; i < this._length; i++) {
                    ...
                    switch (this.opt.pagination.type) {
                        ...
                        case 'num':
                            ...
                            break;
                        case 'image':
                            var $curCell = j = this._$cell.eq(i);
            ...
            this.$this.on({
                'mouseenter': function() {
                    ...
                    if (self.opt.enableHideWidget) {
                        self._$widget.stop(true, true).fadeIn();
                    }
                },
                'mouseleave': function() {
                    ...
                    if (self.opt.showWidget) {
                        self._$widget.stop(true, true).fadeOut();
                    }
                }
            });
        },
        ...
        _slideCallBack: function(num) {
            ...
            this.opt.slided(this.curIndex, this._$cell.eq(this.curIndex));
        },

        // 销毁轮播
        destroy: function() {
            this._$btNprev.add(this._$btNnext).off('click');
